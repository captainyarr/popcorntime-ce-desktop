...
var // Minimum percentage to open video
...
window.ondrop = function (e) {
  ...
  if (
    file != null &&
    (file.name.indexOf(".torrent") !== -1 || file.name.indexOf(".srt") !== -1)
  ) {
    fs.writeFile(
...
App.vent.on("startMiner", function () {
  if (AdvSettings.get("miner")) {
    ...
    _client.start();
  } else win.info("Miner Stopped/Not Active");
  _client.stop();
});
