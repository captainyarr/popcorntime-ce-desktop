...
(function () {
  ...
  videojs.Youtube.prototype.updateIframeSrc = function () {
    ...
    if (!this.videoId && !this.playlistId) {
      ...
      if (this.player_.options()["ytcontrols"]) {
        ...
        this.videoId &&
        (typeof this.player_.poster() === "undefined" ||
          this.player_.poster().length === 0)
      ) {
        // Wait here because the tech is still null in constructor
        setTimeout(function () {
          self.player_.poster(
            "https://img.youtube.com/vi/" + self.videoId + "/0.jpg",
          );
        }, 100);
      }
  ...
  videojs.Youtube.prototype.setVolume = function (percentAsDecimal) {
    if (
      typeof percentAsDecimal !== "undefined" &&
  ...
  videojs.Youtube.prototype.onReady = function () {
    ...
    if (
      typeof this.player_.loadingSpinner !== "undefined" &&
      !this.isIos &&
      !this.isAndroid
    ) {
      this.player_.loadingSpinner.hide();
