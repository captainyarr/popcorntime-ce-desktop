...
(function (root, factory) {
  ...
  deprecate._warn =
    (typeof console !== "undefined" && (console.warn || console.log)) ||
    function () {};
  deprecate._cache = {};
  ...
  Marionette.Region = Marionette.Object.extend(
    {
      ...
      empty: function (options) {
        ...
        var preventDestroy = Marionette._getValue(
          options,
          "preventDestroy",
          this,
        );
  ...
  Marionette.View = Backbone.View.extend({
    ...
    _triggerEventOnParentLayout: function (eventName, args) {
      ...
      Marionette._triggerMethod(
        layoutView,
        [prefixedEventName, this].concat(args),
      );
    ...
    _filteredSortedModels: function () {
      ...
      if (viewComparator) {
        if (_.isString(viewComparator) || viewComparator.length === 1) {
          ...
          models = _.clone(this.collection.models).sort(
            _.bind(viewComparator, this),
          );
        }
      } else {
