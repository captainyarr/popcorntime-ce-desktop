...
(function (App) {
  ...
  function disconnectIcon() {
    ...
    vpnButton
      ...
      .addClass("fa-lock")
      .attr("data-original-title", i18n.__("Disconnect VPN"))
      .attr("id", "filterbar-vpn-disconnect");
    vpnButton.hover(
      function () {
  ...
  function connectIcon() {
    ...
    vpnButton
      ...
      .attr("data-original-title", i18n.__("Connect VPN"))
      .attr("id", "filterbar-vpn-connect");
    vpnButton.hover(
      function () {
        $(this).addClass("fa-lock");
        $(this).removeClass("fa-unlock-alt");
