(function (App) {
  ...
  var Plugins = Backbone.Marionette.ItemView.extend({
    ...
    saveSetting: function (e) {
      ...
      switch (field.attr("name")) {
        ...
        case "pluginRARBGsearch":
          ...
          if (value) AdvSettings.set("onlineSearchEngine", "RARBG");
          else AdvSettings.set("onlineSearchEngine", "KAT");
          break;
        case "pluginKATsearch":
          value = field.is(":checked");
          if (value) AdvSettings.set("onlineSearchEngine", "KAT");
          else AdvSettings.set("onlineSearchEngine", "RARBG");
          break;
        ...
        case "pluginHTML5":
          value = field.is(":checked");
          if (value) AdvSettings.set("chosenPlayer", "html5");
          else AdvSettings.set("chosenPlayer", "local");
          break;
        default:
    ...
    disconnectTrakt: function (e) {
      ...
      App.Trakt.oauth.revokeAccess().then(function (value) {
