(function (App) {
  ...
  var TorrentCollection = Backbone.Marionette.ItemView.extend({
    ...
    changeEngine: function (e) {
      ...
      Settings.onlineProvidersCategories = this.updateCategories(
    ...
    onlineSearch: function (e) {
      ...
      var asyncSearch = async function () {
        ...
        win.debug(
          "torrent browse search engine: %s",
          defaultParams.searchprovider,
        );
        ...
        if (defaultParams.searchprovider === "all") {
          that.torrentBrowse
            .search(input, defaultParams.category, defaultParams.limit)
