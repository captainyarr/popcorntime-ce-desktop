      ...
      if (process.platform == "linux") {
        this.writeDesktopFile(function (err) {
          ...
          require("child_process").exec(
            "gnome-terminal -x bash -c \"echo 'Setting Popcorn Time as default player requires Admin Rights'; echo; sudo echo; sudo echo 'Authentication Successful'; sudo echo; sudo mv -f " +
              desktopFile +
        ...
        require("child_process").exec(
          '"' +
            pctPath +
            'src/duti/duti" -s media.popcorntime-ce.player .torrent viewer',
        );
        alert("Success!");
        AdvSettings.set("registerTorrents", true);
      } else {
