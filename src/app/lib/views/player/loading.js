  ...
  var Loading = Backbone.Marionette.ItemView.extend({
    ...
    onStateUpdate: function () {
      ...
      if (state === "playingExternally") {
        ...
        if (
          ...
          streamInfo.get("player").get("type") === "chromecast"
        ) {
    ...
    onProgressUpdate: function () {
      ...
      this.ui.bufferPercent.text(
        streamInfo.get("buffer_percent").toFixed() + "%",
      );
    ...
    updateDownloadSpeed: function () {
      this.ui.downloadSpeed.text(
        this.model.get("streamInfo").get("downloadSpeed"),
      );
    },
    ...
    updateActivePeers: function () {
      this.ui.progressTextPeers.text(
        this.model.get("streamInfo").get("active_peers"),
      );
    },

    updateTotalPeers: function () {
      this.ui.progressTextSeeds.text(
        this.model.get("streamInfo").get("total_peers"),
      );
    },

    updateTimeRemaining: function () {
      var timeLeft = this.remainingTime(
        this.model.get("streamInfo").get("time_left"),
      );
    ...
    updateDownloadPercent: function () {
      this.ui.bufferPercent.text(
        this.model.get("streamInfo").get("downloadedPercent").toFixed() + "%",
      );
    },
